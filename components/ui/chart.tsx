...
const ChartLegendContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> &
    Pick<RechartsPrimitiveLegend, "payload" | "verticalAlign"> & {
      hideIcon?: boolean
      nameKey?: string
    }
...
// Define props for the ChartContainer and its children
...
const Chart = React.forwardRef<HTMLDivElement, ChartProps>(
  ({ data, config, children, type, className, ...props }, ref) => {
    const ChartComponent: ChartComponent = type === "line" ? LineChart : type === "bar" ? BarChart : AreaChart
